...
//
// 연결은 모듈을 불러올 때가 아니라 실제로 필요할 때 만든다.
// 모듈 로드 시점에 연결하면, DB를 쓰지 않고 끝나는 응답(405, 400 같은)에서는
// 아무도 그 Promise를 기다리지 않는다. 그 사이 연결이 실패하면
// unhandledRejection이 되어 Node가 프로세스를 종료시킨다.
